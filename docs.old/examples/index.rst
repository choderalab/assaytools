...
If you installed `AssayTools` from source, you will need to navigate to
:code:`/path/to/assaytools/examples`. The notebook files for these examples and the notebooks are available in the top level  `examples folder <https://github.com/choderalab/assaytools/tree/master/examples>`_ on github too. In the directory with the notebook
